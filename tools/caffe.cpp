...
using caffe::AnnotatedDataParameter;

/*

namespace caffe {
	template <typename Dtype>  boost::shared_ptr<Layer<Dtype> > CreatorAnnotatedDataLayer(const LayerParameter& param)
	{
		return boost::shared_ptr<Layer<Dtype> >(new caffe::AnnotatedDataLayer<Dtype>(param));
	}
	static LayerRegisterer<float> g_creator_f_AnnotatedData("AnnotatedData", CreatorAnnotatedDataLayer<float>);
	static LayerRegisterer<double> g_creator_d_AnnotatedData("AnnotatedData", CreatorAnnotatedDataLayer<double>);
};
